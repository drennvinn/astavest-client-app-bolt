        ...
        <nav class="sidebar fixed bottom-0 top-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300">
            <div class="h-full bg-white dark:bg-[#0e1726]">
                <div class="flex items-center justify-between px-4 py-3 mb-8">
                    <NuxtLink to="/client" class="main-logo flex shrink-0 items-center">
                    ...
                    >
                        <ul class="relative space-y-0.5 p-4 py-0 font-semibold">
                            <li class="nav-item">
                                <ul class="text-lg">
                                    <li class="nav-item">
                                        <NuxtLink to="/client/profile" class="group" @click="toggleMobileMenu">
                                    ...
                                    <li class="nav-item">
                                        <NuxtLink to="/client/support" class="group" @click="toggleMobileMenu">
                                            <div class="flex items-center">
