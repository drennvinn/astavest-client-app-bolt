                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-col items-center justify-center">
                            <img :src="`${runtimeConfig.public.directusUrl}assets/${cgpCif?.user?.avatar}`" class="mb-5 h-28 w-28 rounded-full object-cover" />
                        ...
                        <ul class="m-auto mt-5 flex max-w-[160px] flex-col space-y-4 font-semibold text-white-dark">
                            <li class="flex items-center gap-2">
                                ...
                                {{ cgpCif?.date_of_birth }}
                            </li>
                            <li class="flex items-center gap-2">
                                <icon-map-pin class="shrink-0" />
                                {{ cgpCif?.city }} {{ cgpCif?.zipcode }}
                            </li>
                            <li>
                                <a href="javascript:;" class="flex items-center gap-2">
                                    <icon-mail class="w-5 h-5 shrink-0" />
                                    <span class="truncate text-primary">{{ cgpCif?.user?.email }}</span></a
                                >
                            </li>
                            <li class="flex items-center gap-2">
                                <icon-phone />
                                <span class="whitespace-nowrap" dir="ltr">{{ cgpCif?.phone }}</span>
                            </li>
                        </ul>
                    </div>
                </div>
...
import type { CgpCif } from '~/types/astavest-crm';
...
const loadUserClient = async () => {
    ...
    try {
        ...
        const req = await $directus.request<CgpCif[]>($readItems('cgp_cif', {
        ...
        console.error('Error loading cgpCif data:', error);
